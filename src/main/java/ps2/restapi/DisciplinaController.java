...
public class DisciplinaController {
    ...
    public DisciplinaController() {
        ...
        disciplinas.add(new Disciplina(1, "Banco de Dado", "BD", "SI", "3º Semestre"));
        disciplinas.add(new Disciplina(2, "Comunicado de Dado", "CD", "SI", "3º Semestre"));
        disciplinas.add(new Disciplina(3, "Principio de Empreendedorismo", "PE", "SI", "3º Semestre"));
    }
